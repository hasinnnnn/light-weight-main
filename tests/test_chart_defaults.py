...
class ChartDefaultTests(unittest.TestCase):
    ...
    def test_initialize_session_state_sets_bumi_and_visible_default_ema(self) -> None:
        ...
        self.assertEqual(st.session_state.period_option, "1y")
        self.assertEqual(st.session_state.backtest_period_label, "1y")
        ...
        self.assertEqual(st.session_state.screener_period_label, "1y")
